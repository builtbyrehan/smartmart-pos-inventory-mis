...
export function UsersPage() {
  ...
  const columns: Column<User>[] = [
    {
      ...
      render: (u) => (
        <div className="flex items-center gap-3">
          ...
          <div>
            <strong className="text-fg">{u.full_name}</strong>
    ...
    },
    {
      key: 'role',
      header: 'Role',
      render: (u) => <span className="badge badge-brand">{u.role}</span>,
    },
    {
      key: 'active',
      header: 'Status',
      render: (u) => (
        <span
          className={`badge ${u.is_active ? 'badge-success' : 'badge-neutral'}`}
        >
  ...
  return (
    <>
      <PageHeader
        title="Users"
        subtitle="Administer staff accounts and role-based access."
        action={
